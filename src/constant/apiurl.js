...
export const BASE_URL = "https://admin-dashboard-backend-vy2e.onrender.com"
...
export const ADD_DB_FILE = BASE_URL + "/uploadFile"
export const GET_DB_FILE = BASE_URL + "/files"
